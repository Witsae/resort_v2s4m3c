...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <ASIDE class='aside_left'>
    ${categrpVO.name } > ${cateVO.name } > ${contentsVO.title} 관련 Youtube 등록
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' id='frm' method='POST' action='./youtube_create.do' class="form-horizontal">
      <!-- FK memberno 지정 -->
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='youtube' id='youtube' rows='6' placeholder="Youtube에서 복사된 소스"></textarea>
        </div>
      </div>
